...
开启日期：2026-09-15。状态：**按“部分通过”合入本地 `openai-responses-migration`；未推送**。
...
再次独立复验与测试断言补强见 [06 独立复验](./06-reacceptance.md)。合入保留 [05 §7 独立验收](./05-implementation-acceptance.md) 的范围限制：真实百万窗口自动越过 95% 与真实上游 overflow 未实测，估算表不同采样点不能混作精确对账。
