...
| OpenAPI / 协议文档自动化 | 当前只有 `create-app.ts` 手写信息性 `/doc`；`@hono/zod-openapi` 和生成 client 仍未到投资点。Browser client 直接实现 SDK 合同。见 [`hono-app/02`](./hono-app/02-web-api-surface.md) §4 |
