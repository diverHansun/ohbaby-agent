...
- Bundling workspace packages under pnpm's isolated node linker can pull symlinked dependency trees into the tarball or fail during pack. This task avoids bundling and treats `ohbaby-sdk` and `ohbaby-cli` as publishable packages.
