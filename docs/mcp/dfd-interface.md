...
工作区A: /path/to/project-a
   ...
   │     │
   │     ├─→ 加载全局配置: ~/.iris-code/mcp/settings.json
   │     ├─→ 加载项目配置: /path/to/project-a/.iris-code/mcp/settings.json
   │     ├─→ 合并配置
   │     └─→ 创建独立的clients Map
   │
   └─→ 工作区A的Tool[]
...
工作区B: /path/to/project-b
   ...
   │     │
   │     ├─→ 加载全局配置: ~/.iris-code/mcp/settings.json
   │     ├─→ 加载项目配置: /path/to/project-b/.iris-code/mcp/settings.json
   │     ├─→ 合并配置
   │     └─→ 创建独立的clients Map
   │
   └─→ 工作区B的Tool[]
...
loadMcpConfig()
   │
   ├─→ 全局: ~/.iris-code/mcp/settings.json
   │     {
   │       "mcpServers": {
   ...
   │     }
   │
   ├─→ 项目: {workspace}/.iris-code/mcp/settings.json
   │     {
   │       "mcpServers": {
