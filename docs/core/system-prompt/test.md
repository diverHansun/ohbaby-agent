...
describe('CustomLayer', () => {
  describe('load', () => {
    it('should load project IRIS.md', async () => {
      mockFs.write('.iris-code/IRIS.md', '# Project Instructions')
    ...
    it('should load global IRIS.md', async () => {
      mockFs.write('~/.iris-code/IRIS.md', '# Global Instructions')
    ...
    it('should merge project and global instructions', async () => {
      mockFs.write('.iris-code/IRIS.md', '# Project')
      mockFs.write('~/.iris-code/IRIS.md', '# Global')
    ...
    it('should handle file read errors gracefully', async () => {
      mockFs.setReadError('.iris-code/IRIS.md', new Error('Permission denied'))
...
describe('Custom Instructions Integration', () => {
  ...
  it('should load and include in primary agent prompt', async () => {
    mockFs.write('.iris-code/IRIS.md', '# Custom Instructions\nUse Jest')
  ...
  it('should prioritize project over global instructions', async () => {
    mockFs.write('.iris-code/IRIS.md', '# Project: Use Vitest')
    mockFs.write('~/.iris-code/IRIS.md', '# Global: Use Jest')
...
describe('Edge Cases - Large Files', () => {
  it('should truncate oversized custom instructions', async () => {
    ...
    mockFs.write('.iris-code/IRIS.md', largeContent)
...
describe('Edge Cases - Special Characters', () => {
  it('should handle unicode in custom instructions', async () => {
    mockFs.write('.iris-code/IRIS.md', '# Instructions\n使用中文注释')
  ...
  it('should handle special markdown characters', async () => {
    mockFs.write('.iris-code/IRIS.md', '# Title\n- Item `code` **bold**')
...
describe('Error Handling', () => {
  ...
  describe('file system errors', () => {
    it('should handle permission denied gracefully', async () => {
      mockFs.setReadError('.iris-code/IRIS.md', new Error('EACCES'))
...
// Config Mock
const mockConfig = {
  getProjectPath: vi.fn().mockReturnValue('/project/.iris-code'),
  getGlobalPath: vi.fn().mockReturnValue('/home/user/.iris-code')
}
