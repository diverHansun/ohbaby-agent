# iris-code Architecture Analysis & Design Direction

## Executive Summary

Based on detailed analysis of `gemini-cli` and `mini-kode` core architectures, combined with iris-code's existing tutorial documents, this document provides:
...
4. **Architecture Direction**: Recommended design strategy for iris-code

**Key Insight**: iris-code is positioned between gemini-cli (feature-rich) and mini-kode (minimal) - it should adopt gemini-cli's architectural sophistication with mini-kode's clarity and separation of concerns.

---

## Part 1: Gap Analysis - What's Missing from src/core

### Current State of iris-code/src/core
...
**Design Pattern**: Based on iris-code tutorial `conversation-design.md`
...
**Design Pattern**: Based on iris-code tutorial `turn-hook.md`
...
## Part 4: Architecture Direction for iris-code

### Strategic Positioning

iris-code should position itself as:
...
Based on gemini-cli and mini-kode analysis, iris-code should follow:
...
### iris-code vs gemini-cli vs mini-kode

| Aspect | gemini-cli | mini-kode | iris-code (Target) |
|--------|-----------|----------|-------------------|
...
iris-code is positioned to be a **modern, maintainable, and extensible AI coding assistant** that combines:
- **gemini-cli's sophistication** (hooks, routing, error recovery)
- **mini-kode's clarity** (simple loop, callback-driven, readable)
- **iris-code's tailoring** (code-focused tools, IDE integration)
...
By following the layered architecture and callback-driven patterns outlined above, iris-code will achieve high maintainability while providing the extensibility needed for enterprise use.
